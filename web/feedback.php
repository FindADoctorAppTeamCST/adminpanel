  ...
  <div class="form-group">
   ...
   <button type="submit" class="btn btn-default" style="background:#43D1AF">Submit</button>
	 ...
	 <div id="centerdiv">
			...
			<div id="fmain" class="myform">
		<h1>Provide you Feedback.</h1>
		<form method="POST" action="#">
						<textarea rows="13" cols="48.5" name="a" placeholder="Enter your feedback here.To help protect your privacy,don't include personal information,like you name or address."></textarea><br><br>
			<input type="submit" id="inbt" value="Submit">
