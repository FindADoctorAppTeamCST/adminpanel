  ...
  <div class="form-group">
   ...
   <button type="submit" class="btn btn-default" style="background:#43D1AF">Submit</button>
	 ...
	 <div id="centerdiv">
			...
			<h1 id="h1">&emsp;&emsp;Section
		</h1>
	
			<p>
			Each of the modules consists of three sections:
			</p>
			<ul>
				<li>Assessment</li>
				<li>Management</li>
			...
			&emsp;&emsp;&emsp;&emsp;
			&emsp;<img src="section/section.jpg" width="70%" height="30%"></img>
			
		<h2 id="h2">Assessment</h2>
		  <p>  The Assessment section is presented in a framework of
