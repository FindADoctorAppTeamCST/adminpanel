...
<html lang="en">
  ...
  <ul class="dropdown-menu">
      ...
      <div class="col-md-7">
		...
		<h1 style="background-color:#223C97">Add Patient</h1>
		<form method="POST" action="#">
			<input type="text" id="in" placeholder="Patient Name"><br>
			<input type="text" id="in" placeholder="MNS Condition"><br>
			<input type="text" id="in" placeholder="Address"><br>
			<input type="number" id="in" placeholder="Check in Date">
			<input type="number" id="in" placeholder="Mobile Number">
			<input type="submit" id="inbt" value="Submit" style="background-color:#223C97">
