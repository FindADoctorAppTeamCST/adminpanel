			...
			<div id="content">
				...
				<!--Links to script to verify user -->
					...
					<br/><br/>
						...
						<span style="color:#FF0000;font-size:1vw">Incorrect Username or Password</span><br/><br/>
					
						<p style="font-size:1vw"><a href="Securityquestion.php" title="Click here to reset your Password" id="forgot">Forgot your password?</a></p>
				</form>
			</div>
		</div>
